...
def _args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plan/execute a clean LOEO adaptation of the pinned organizer 3-epoch baseline."
    )
...
def main() -> None:
    ...
    protocol = build_organizer_protocol(inventory, fold_name=args.fold, organizer_fold_index=0)
    ...
    leakage_controls = (
        "held-out embryo absent from organizer trainer train list",
        "held-out embryo absent from organizer trainer checkpoint-monitor/test list",
    ...
    manifest = ExperimentManifest(
        ...
        hypothesis=(
            "The holdout-safe 3-epoch organizer baseline establishes a clean cross-embryo reference "
